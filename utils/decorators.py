...
class IconicDecorator(object):
    def __init__(self):
        self.PASS = Style.BRIGHT + Fore.GREEN + "[ تم ]" + Style.RESET_ALL
        self.FAIL = Style.BRIGHT + Fore.RED + "[ خطء ]" + Style.RESET_ALL
        self.WARN = Style.BRIGHT + Fore.YELLOW + "[ خطء ]" + Style.RESET_ALL
