...
pkg install git
pkg install python
git clone https://github.com/WAAL123.git
cd Tbomb
chmod +x TBomb.sh
./TBomb.sh
```
...
/usr/bin/ruby -e "$(curl -fsSL https://raw.githubusercontent.com/WAAL123/install/master/install)"
...
git clone https://github.com/WAAL123
cd TBomb
chmod +x TBomb.sh
...
- **SpeedX**<br>
[-] Mail At:https://github.com/WAAL123
