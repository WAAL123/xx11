...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/waal123/Tbomb/archive/refs/heads/master.zip"
        dir_name = "TBomb-dev"
    else:
        zip_url = "https://github.com/waal123/Tbomb/archive/refs/heads/master.zip"
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://github.com/waal123/Tbomb/blob/master/.version"
    ).text.strip()
    if fver != __VERSION__:
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/waal123/Tbomb/blob/master/.notify"
        else:
            url = "https://github.com/waal123/Tbomb/blob/master/.notify"
...
def selectnode(mode="sms"):
    ...
    try:
      ...
      waal123()
        ...
        max_limit = {"sms": 5000, "call": 1500, "mail": 10000}
        cc, target = "", ""
        if mode in ["sms", "call"]:
